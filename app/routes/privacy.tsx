      ...
      <div className="prose prose-invert max-w-none space-y-8">
        <section>
          ...
          <p className="text-gray-300">
            This privacy policy describes how jimmyvanveen.com (&quot;we&quot;, &quot;our&quot;, or
            &quot;us&quot;) collects, uses, and protects information when you visit our website.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-2 text-gray-200">Analytics Data</h3>
          <p className="text-gray-300 mb-4">
            We collect basic analytics data for security monitoring, performance optimization, and
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Security monitoring:</strong> Detecting and preventing attacks or abuse
            </li>
            <li>
              <strong>Performance optimization:</strong> Improving site speed and functionality
            </li>
            <li>
              <strong>Error tracking:</strong> Identifying and fixing technical issues
            </li>
            <li>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 text-white">Your Privacy Choices</h2>
          <p className="text-gray-300 mb-4">
          ...
          <p className="text-gray-300 mt-4">
            Opting out will not affect core website functionality but may limit our ability to
            detect and prevent security issues.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4 text-white">Data Security and Retention</h2>
          <p className="text-gray-300">
